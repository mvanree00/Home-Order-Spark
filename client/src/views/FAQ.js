...
return(
     <div>
          <Typography variant="h1" className="topHeader">FAQ</Typography>
          ...
          <Typography variant="h2" className="topHeader"> Questions pertaining to the Customer Account</Typography>
          ...
          <Typography variant="h2" className="topHeader"> Questions pertaining to the Volunteer Account</Typography>
          ...
          <Typography variant="h2" className="topHeader"> Questions pertaining to the Store Owner Account</Typography>
          ...
          <Typography variant="h2" className="topHeader"> Questions pertaining to the Forum</Typography>
