...
How can I view my cart?</Typography>
<Typography  className="Text"> Naviagate to the Cart tab to view your cart. You can delete items not needed anymore from there.</Typography><Typography variant="h3" className="Header"> How can I review my order?</Typography>
<Typography  className="Text"> On your dashboard, found using the Orders tab, your recent order will be viewable at the top of the page. </Typography><Typography variant="h3" className="Header"> What is the Create Job Tab?</Typography>
<Typography  className="Text"> If you have any work or home improvements that need to be done, creating a work order/job will allow volunteers to come and assist you. To create a job, navigate to the Create Job tab. Once on the new screen, provide the work categroy and full description of the job. Once the job is submitted, a volunteer will be in contact shortly. 
 </Typography><Typography variant="h3" className="Header"> Where can I find jobs I've created?</Typography>
...
<Typography variant="h2" className="Header"> Questions pertaining to the Volunteer Account</Typography>
 </Typography><Typography variant="h3" className="Header"> I'm a volunteer. What is my dashboard?</Typography>
...
</Typography><Typography variant="h3" className="Header"> Where can I find open jobs?</Typography>
<Typography  className="Text"> Open jobs will be viewable from the dashboard as well as the Accept Orders tab. </Typography>
</Typography><Typography variant="h3" className="Header"> How do i accept them?</Typography>
<Typography  className="Text"> In the Accept Orders tab, there is a button to accept the order.  </Typography>
</Typography><Typography variant="h3" className="Header"> 
Where do I find the customer's information?</Typography>
<Typography  className="Text"> In the view orders screen, the customer's information is located at the top.   </Typography>
</Typography><Typography variant="h3" className="Header"> Where can I mark them complete?</Typography>
<Typography  className="Text"> In the current orders tab, click on the delivered button.  </Typography>
</Typography><Typography variant="h3" className="Header"> I can't complete an order. How do I cancel it?</Typography>
...
<Typography variant="h2" className="Header"> Questions pertaining to the Store Owner Account</Typography>
 </Typography><Typography variant="h3" className="Header"> I'm a store owner? How do I add to my inventory?</Typography>
...
</Typography><Typography variant="h3" className="Header"> How do I add multiple items to my inventory?</Typography>
<Typography  className="Text"> Under the input fields is an option to upload a .xlsx (an excel) document.  </Typography>
</Typography><Typography variant="h3" className="Header"> How can I view my inventory?</Typography>
<Typography  className="Text"> Your store's inventory can be viewed from the Store Inventory tab.  </Typography>
</Typography><Typography variant="h3" className="Header"> 
How can i delete from my inventory?</Typography>
...
<Typography variant="h2" className="Header"> Questions pertaining to the Forum</Typography>
 </Typography><Typography variant="h3" className="Header">What is the forum?</Typography>
...
</Typography><Typography variant="h3" className="Header"> How do I create a post?</Typography>
...
</Typography><Typography variant="h3" className="Header"> How do I respond to a post?</Typography>
